...
public class JanelaClassificacao {
	...
	/**
	 * Cria e retorna a instacia de JFrame da janela de atualização da classificação do time
	 * @return O JFrame da janela de atualizaçãoo da classificação do time.
	 */
	...
	public static JFrame criarJanelaJogador() {
		...
		janelaClassificacao.setResizable(false);
		...
		// Define se os campos estão habilitados ou não no inicio
		...
		// Adicionou um Listener na janela, nesse caso para quando estiver fechando simular um clique no botÃ£o limpar para limpar a janela 
